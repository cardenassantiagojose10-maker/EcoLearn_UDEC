...
<title>Iniciar sesión — EcoLearn UDEC</title>
...
<style>
  ...
  * { box-sizing:border-box; margin:0; padding:0; }
  ...
  .alert-box.ok  { background:rgba(30,142,90,.10); border:1px solid rgba(30,142,90,.3); color:var(--verde-ink); }
  ...
  .foot { text-align:center; font-size:11px; color:var(--ink-soft); margin-top:16px; }
...
<div class="auth-card">
  ...
  <div class="brand-panel">
    <div>
      ...
      <h2>Aprende, actúa,<br>cierra el ciclo</h2>
      <p>Plataforma de educación ambiental de la Universidad de Cundinamarca.</p>
      ...
      <div class="field">
        ...
        <div class="input-wrap">
          ...
          <input type="email" id="email" name="email" value="{{ old('email') }}"
                 placeholder="usuario@ucundinamarca.edu.co" required autofocus>
        </div>
      </div>
